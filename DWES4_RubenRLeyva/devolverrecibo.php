...
if(isset($_SESSION['usuario'])){
    ...
    foreach ($movimientos as $indice => $movimiento){
        if ($movimiento->getCantidad() < 0){
            $movimientosNegativos[] = $movimiento;
        }
    }
                                       
    // los mostraremos
    $smarty->assign('devolverrecibo', $movimientosNegativos);
...
$smarty->display('devolverrecibo.tpl');
